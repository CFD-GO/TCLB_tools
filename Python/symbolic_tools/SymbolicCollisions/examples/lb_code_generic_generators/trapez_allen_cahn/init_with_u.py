...
from SymbolicCollisions.core.printers import print_as_vector, get_print_symbols_in_m_notation, get_vector_of_eq_moments
...
### PREPARE ENVIROMENT ###
Init_Phi = Symbol('tilde_phi', positive=True)  # number
m_eq = get_vector_of_eq_moments(Init_Phi, Sigma2asSymbol)
