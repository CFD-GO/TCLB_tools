...
eq_populations = get_print_symbols_in_m_notation(moments_dict[f'D{d}Q{q}'], pop_eq_str)
...
print_as_vector(hardcoded_cm_eq, outprint_symbol=pop_eq_str, moments_order=moments_dict[f'D{d}Q{q}'])

print("\n\t//back to raw moments")
print_as_vector(Nraw.inv() * eq_populations, outprint_symbol=temp_pop_str, moments_order=moments_dict[f'D{d}Q{q}'])
...
print_as_vector(eq_populations, outprint_symbol=pop_eq_str, moments_order=moments_dict[f'D{d}Q{q}'])
# print_as_vector(populations, outprint_symbol=pop_in_str, moments_order=e)
