...
print('----------------------------------------------------------------------')
stuff = re.sub(r'f\[0\]', 'f000', stuff)  # this is rather good...
stuff = re.sub(r'f\[1\]', 'f100', stuff)
stuff = re.sub(r'f\[2\]', 'f010', stuff)
stuff = re.sub(r'f\[3\]', 'f200', stuff)
stuff = re.sub(r'f\[4\]', 'f020', stuff)
stuff = re.sub(r'f\[5\]', 'f110', stuff)
stuff = re.sub(r'f\[6\]', 'f210', stuff)
stuff = re.sub(r'f\[7\]', 'f220', stuff)
stuff = re.sub(r'f\[8\]', 'f120', stuff)

stuff = re.sub(r'c\[0\]', 'c000', stuff)  # this is rather good...
stuff = re.sub(r'c\[1\]', 'c100', stuff)
stuff = re.sub(r'c\[2\]', 'c010', stuff)
stuff = re.sub(r'c\[3\]', 'c200', stuff)
stuff = re.sub(r'c\[4\]', 'c020', stuff)
stuff = re.sub(r'c\[5\]', 'c110', stuff)
stuff = re.sub(r'c\[6\]', 'c210', stuff)
stuff = re.sub(r'c\[7\]', 'c220', stuff)
stuff = re.sub(r'c\[8\]', 'c120', stuff)
